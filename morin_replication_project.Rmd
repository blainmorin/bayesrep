...
pricemodel = model.frame(log(price) ~ bathroom + sqft + I(sqft^2) + age + stry + I(dist_Shoreline_m / 10) + OceanFront + Nourish + PostNourish + Nourish*PostNourish + city + sale_year, data = df1)
...
price.fit = stan("ols.stan", data = price.data, seed = 1234, iter = 4000)
